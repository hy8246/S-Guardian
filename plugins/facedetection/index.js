...
var face_cascade = new cv.CascadeClassifier(path.join('/Users/yuh/Desktop/ardrone-webflight','node_modules','opencv','data','haarcascade_frontalface_alt2.xml'));
...
function facedetection(name, deps) {
    debug = deps.debug || false;
    io = deps.io;
    io.sockets.on('connection', function (socket) {
        socket.on('/facedetection', function (cmd) {
