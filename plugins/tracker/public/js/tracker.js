(function(window, document) {
    ...
    var Tracker = function Tracker(cockpit) {
        ...
        this.div.addEventListener('click', function(event) {
            tracker.setTrackingCoords(eve nt.offsetX, event.offsetY);
        });

        this.enabled = false;
        this.observers = {};
        this.locked = false;
        //attach the target picture into the website page.
        ...
        //pass in the location of the picture.
    ...
    Tracker.prototype.update = function (frameBuffer) { 
        ...
        if (this.point_status[0] == 1) {
            ...
            //output the location of the mark
            console.log(roundedX + " and " + roundedY);
            //handle the movement and try to put the tag back to the center
            if((roundedX-780)>20)
            {
            ...
            //check if the target is locked and move
            if (
                (! this.locked) ||
